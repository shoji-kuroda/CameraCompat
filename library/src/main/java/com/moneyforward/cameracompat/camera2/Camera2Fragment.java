...
public class Camera2Fragment extends Fragment implements CameraCompatFragment, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    private final ImageReader.OnImageAvailableListener onImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            backgroundHandler.post(new ImageSaver(reader.acquireNextImage(), cameraCompatCallback));
        }
    ...
    private static class ImageSaver implements Runnable {
        ...
        public ImageSaver(Image image, CameraCompatCallback callback) {
            mImage = image;
        ...
        public void run() {
            ...
            buffer.get(bytes);
            bytes = rotateImage(180, bytes);
            cameraCompatCallback.takePicture(bytes);
            mImage.close();
        }
    }
    ...
    public static byte[] rotateImage(int angle, byte[] bytes) {
